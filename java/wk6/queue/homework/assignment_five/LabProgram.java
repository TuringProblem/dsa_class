...
public class LabProgram {
  public static void main(String[] args) {
    ...
    while (!quit) {
      ...
      switch (command) {
        case "print" -> groceryList.print(testFeedback);
        case "add " -> groceryList.addWithUndo(command.substring(4));
        // case "removeat " -> groceryList.();
        case "swap " -> groceryList.print(testFeedback);
        case "undo" -> groceryList.print(testFeedback);
