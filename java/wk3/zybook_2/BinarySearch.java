...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        String[] sortedFruits = { "Apple", "Apricot", "Banana", "Blueberry", "Cherry", "Grape", "Grapefruit", "Guava",
                "Lemon", "Lime", "Orange", "Peach", "Pear", "Pineapple", "Raspberry", "Strawberry" };
        String[] fruitSearches = { "Nectarine", "Mango", "Guava", "Strawberry", "Kiwi", "Apple", "Raspberry", "Carrot",
                "Lemon", "Bread" };
        ...
        Integer[] integerSearches = { 42, 23, 11, 19, 87, 98, 54, 66, 92, 1, 14, 21, 66, 87, 83 };
        int[] expectedIntegerSearchResults = { 4, -1, 0, -1, -1, 12, -1, 6, -1, -1, -1, 1, 6, -1, -1 };

        IntComparer intComparer = new IntComparer();
        PrintSearches<Integer> integerResults = new PrintSearches<Integer>();

        integerResults.print(integers, integers.length, integerSearches, integerSearches.length, intComparer,
