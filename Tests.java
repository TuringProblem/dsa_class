...
public class Tests {
  public static boolean testGetScoreAndSetScore() {
    ...
    for (var testCase : testCases) {
      String assignmentName = testCase.getVar0();
      Integer studentID = testCase.getVar1();
      Double expected = testCase.getVar2();
  ...
  public static boolean testGetAssignmentScores() {
    ...
    for (var testCase : testCases) {
      String assignmentName = testCase.getVar0();
      HashMap<Integer, Double> expectedMap = testCase.getVar1();
  ...
  public static boolean testGetStudentScores() {
    ...
    HashMap<String, Double> student90000Scores = new HashMap<String, Double>() {
      {
        put("Homework 1", 80.0);
        put("Homework 2", 85.0);
        put("Midterm", 90.0);
    ...
    // Iterate through all test cases
    for (var testCase : testCases) {
      Integer studentID = testCase.getVar0();
      HashMap<String, Double> expectedMap = testCase.getVar1();

      // Get the actual map from the gradebook
      System.out.print("Calling getStudentScores(");
      System.out.print(studentID);
      System.out.print(")");
      System.out.print("\n");
      ...
      for (String key : expectedMap.keySet()) {
        ...
        if (!areEqual) {
          ...
          System.out.print(") returned a map that has a score of ");
          System.out.print(actualScore);
          System.out.print(" for assignment \"");
          System.out.print(assignmentName);
          System.out.print("\", but the expected score is ");
          System.out.print(expectedScore);
          System.out.print("\n");
      ...
      // All entries match
      System.out.print("PASS: getStudentScores(");
      System.out.print(studentID);
      System.out.print(") returned a map with ");
      System.out.print(actualMap.size());
      System.out.print(" correct scores");
